...
if (!window.customElements.get("ha-mi-humidifier-card")) {
  ...
  let r = class extends _ {
    ...
    _renderImage() {
      const t = new URL("./humidifier-1.png", import.meta.url).href;
      return g`
        <img 
          src="${t}"
          alt="Mi Humidifier"
          ...
          @error=${(i) => {
        const a = i.target;
        console.log("❌ Failed to load image. Please check:"), console.log("   humidifier-1.png"), console.log("Current src:", a.src), a.style.display = "none";
        const e = a.parentElement;
        if (e) {
          const o = document.createElement("div");
          o.className = "image-error", o.textContent = "⚠️ Image not found", e.appendChild(o);
        }
      }}
        />
      `;
